...
array('I-JADE','翡翠台(国际版)'),
array('I-NEWS','无线新闻(国际版)'),
array('I-STYLE','TVB生活台'),
array('I-ENEW','娱乐新闻'),
array('I-XHCC','TVB星河'),
array('I-AACT','TVB功夫台'),
array('I-CLM','TVB粤语片'),
...
//https://apisfm.tvbanywhere.com.sg/epg/get/I-STYLE/2024-07-29/language/tc/+08
 $url5='https://apisfm.tvbanywhere.com.sg/epg/v2/get/'.$cid5[$id5-1][0].'/'.$dt1.'/language/tc/+8.0';
//https://apisfm.tvbanywhere.com.sg/epg/get/CCMC/2025-12-04/language/tc/+08
//https://apisfm.tvbanywhere.com.sg/epg/get/I-XHCC/2025-03-29/language/tc/+08
//https://apisfm.tvbanywhere.com.sg/epg/v2/get/CCMC/2025-12-06/language/tc/+08
$idd5=$id5+$idn5;
    $ch5 = curl_init();
...
$chn.="<programme start=\"".str_replace(' ','',str_replace('-','',str_replace(':','',date('Y-m-d H:i:s', $us20[$i20][1])))).' +0800'."\" stop=\"".str_replace(' ','',str_replace('-','',str_replace(':','',date('Y-m-d H:i:s', $us20[$i20+1][1])))).' +0800'."\" channel=\"".$cid5[$id5-1][1]."\">\n<title lang=\"zh\">". $ue20[$i20][1]."</title>\n<desc lang=\"zh\"> </desc>\n</programme>\n";
 ...
 $url51='https://apisfm.tvbanywhere.com.sg/epg/v2/get/'.$cid5[$id5-1][0].'/'.$dt2.'/language/tc/+8.0';
...
array('608917627','大湾区卫视'), 
array('849119120','海峡卫视'), 
array('956904896','中国农林卫视'), 
array('956904896','中国农林卫视'), 
array('608807419','CCTV4欧洲'), 
array('608807416','CCTV4美洲'), 
array('884121956','老故事'), 
array('708869532','中学生'), 

array('651632657','上海新闻综合'), 
array('617290047','上视东方影视'), 
array('608780988','上海第一财经'), 
array('838109047','南京新闻综合频道'),
 array('838153729','南京教科频道'),
 array('838151753','南京十八频道'), 
array('626064707','江苏体育休闲频道'), 
array('626064714','江苏城市频道'),
 array('626064674','江苏国际'), 
array('628008321','江苏教育'),
 array('626064697','江苏影视频道'),
 array('626065193','江苏综艺频道'),
 array('626064693','江苏公共新闻频道'), 
array('956923159','财富天下'), 
array('639731825','盐城新闻综合'), 
array('639731826','淮安新闻综合'), 
array('639731818','泰州新闻综合'),
 array('639731715','连云港新闻综合'), 
array('639731832','宿迁新闻综合'),
 array('639731747','徐州新闻综合'), 
array('626064703','优漫卡通频道'), 
array('955227979','江阴新闻综合'), 
array('955227985','南通新闻综合'), 
array('955227996','宜兴新闻综合'), 
array('639731952','苏州新闻综合'), 
array('639737327','溧水新闻综合'), 
array('956909362','陕西银龄频道'),
 array('956909358','陕西都市青春频道'), 
array('956909356','陕西体育休闲频道'),
 array('956909303','陕西秦腔频道'), 
array('956909289','陕西新闻资讯频道'), 
...
$url8='https://program-sc.miguvideo.com/live/v2/tv-programs-data/'.$cid8[$idm8-1][0].'/'.$dt11;
...
curl_setopt($ch8,CURLOPT_ENCODING,'Vary: Accept-Encoding');
 ...
 $data98=json_decode($re8)->body->program[0]->content;
//print_r( $data98);
$tuu98=count($data98);
//print $tuu98;
...
$contName=$data98[$i98]->contName;  //题目
//$matchField1=$data98[$i98]->matchField;  //比赛场地
$chn.="<programme start=\"".date("YmdHis",$startTime/1000).' +0800'."\" stop=\"".date("YmdHis",$endTime/1000).' +0800'."\"  channel=\"".$cid8[$idm8-1][1]."\">\n<title lang=\"zh\">".$contName."</title>\n<desc lang=\"zh\">/</desc>\n</programme>\n";
}
$url81='https://program-sc.miguvideo.com/live/v2/tv-programs-data/'.$cid8[$idm8-1][0].'/'.$dt12;



    $ch81 = curl_init();
    curl_setopt($ch81, CURLOPT_URL, $url81);
    curl_setopt($ch81, CURLOPT_RETURNTRANSFER, 1);
    curl_setopt($ch81, CURLOPT_SSL_VERIFYPEER, FALSE);
    curl_setopt($ch81, CURLOPT_SSL_VERIFYHOST, FALSE);
    curl_setopt($ch81, CURLOPT_TIMEOUT, 30); 
curl_setopt($ch81,CURLOPT_USERAGENT,'Mozilla/5.0');
curl_setopt($ch81,CURLOPT_ENCODING,'Vary: Accept-Encoding');
    $re81 = curl_exec($ch81);
    curl_close($ch81);

 $data981=json_decode($re81)->body->program[0]->content;

$tuu981=count($data981);


for ( $i981=0 ; $i981<=$tuu981-1 ; $i981++ ) {
$startTime=$data981[$i981]->startTime;  //开始时间
$endTime=$data981[$i981]->endTime;  //题目
$contName=$data981[$i981]->contName;  //题目
...
$chn.="<programme start=\"2025".str_replace('月','',str_replace(' ','',str_replace('日','',str_replace('AM','',str_replace('PM','',str_replace(':','',$un13[$k13-1][1])))))).'00 +0800'."\" stop=\"2025".(str_replace('月','',str_replace(' ','',str_replace('日','',str_replace('AM','',str_replace('PM','',str_replace(':','',$un13[$k13-1][1]))))))).'00 +0630'."\" channel=\"看看新聞直播\">\n<title lang=\"zh\">".$um13[$k13*2][1]."</title>\n<desc lang=\"zh\">".$um13[$k13*2][1]." </desc>\n</programme>\n";
//$chn.="<programme start=\"2025".str_replace('月','',str_replace(' ','',str_replace('日','',str_replace('AM','',str_replace('PM','',str_replace(':','',$un13[$k13-1][1])))))).'00 +0800'."\" stop=\"2025".(str_replace('月','',str_replace(' ','',str_replace('日','',str_replace('AM','',str_replace('PM','',str_replace(':','',$un13[$k13-1][1]))))))+60).'00 +0800'."\" channel=\"看看新聞直播\">\n<title lang=\"zh\">".$um13[$k13*2][1]."</title>\n<desc lang=\"zh\">".$um13[$k13*2][1]." </desc>\n</programme>\n";
} 
...
//$url161='https://yicai.smgbb.cn/api/ajax/getlivelist?page=1&pagesize=200&action=mix';
$url161='https://yicai.smgbb.cn/api/ajax/getlivelist?page=1&pagesize=200&action=mix';
$ch161 = curl_init();
   ...
   $re161 = curl_exec($ch161);
    curl_close($ch161);
preg_match_all('|(.*?)"LiveState":1|i',$re161,$unk161,PREG_SET_ORDER);//播放狀態
//print_r($unk161);
$trm161=count($unk161);
preg_match_all('|"NewsTitle":"(.*?)"|i',$re161,$umk162,PREG_SET_ORDER);//節目標題
preg_match_all('|"LiveDate":"(.*?)"|i',$re161,$ulk162,PREG_SET_ORDER);//"LiveDate":"2021-08-09 09:30",
preg_match_all('|"NewsNotes":"(.*?)",|i',$re161,$unk162,PREG_SET_ORDER);//"LiveDate":"2021-08-09 09:30",

//print_r($umk161);
//print_r($ulk161);
$trm162=count($ulk162);

for ($k161 = 0; $k161<=$trm162-1; $k161++) { 

  $chn.="<programme start=\"".str_replace('-','',str_replace(':','',str_replace(' ','',$ulk162[$k161][1])))
.'00 +0800'."\" stop=\"".(str_replace('-','',str_replace(':','',str_replace(' ','',$ulk162[$k161][1])))
+100).'00 +0800'."\" channel=\"第一財經直播\">\n<title lang=\"zh\">".trim($umk162[$k161][1])."</title>\n<desc lang=\"zh\"> ".trim($unk162[$k161][1])."</desc>\n</programme>\n";
 }
...
array('600193252','兵团卫视'),

array('600213139','国学频道'),
...
//      https://h5access.yangshipin.cn/web/tv_program?targetId=1&vappid=59306155&vsecret=b42702bf7309a179d102f3d51b1add2fda0bc7ada64cb801&raw=1&type=by_day&pid=600193252&day=2025-12-03&ts=882371841
//      https://h5access.yangshipin.cn/web/h5_share?vappid=59306155&vsecret=b42702bf7309a179d102f3d51b1add2fda0bc7ada64cb801&raw=1&shareToType=1&shareId=itemtype%3Dtv%26pid%3D600193252&shareFrom=h5
//      https://h5access.yangshipin.cn/web/tv_program?targetId=1&vappid=59306155&vsecret=b42702bf7309a179d102f3d51b1add2fda0bc7ada64cb801&raw=1&type=by_day&pid=600193252&day=2025-12-03;
     // https://h5access.yangshipin.cn/web/tv_program?targetId=1&vappid=59306155&vsecret=b42702bf7309a179d102f3d51b1add2fda0bc7ada64cb801&raw=1&type=by_day&pid=600190403&day=2025-12-03&ts=882371715   
$url29='https://h5access.yangshipin.cn/web/tv_program?targetId=1&vappid=59306155&vsecret=b42702bf7309a179d102f3d51b1add2fda0bc7ada64cb801&raw=1&type=by_day&pid='.$cid29[$idm29-1][0].'&day='.$dt1;
      //https://h5access.yangshipin.cn/web/tv_program?targetId=1&vappid=59306155&vsecret=b42702bf7309a179d102f3d51b1add2fda0bc7ada64cb801&raw=1&type=by_day&pid=600193252&day=2025-12-03$idd29=$id29+$idm29;
$ch29= curl_init ();
...
))).' +0800'."\" channel=\"".$cid29[$idm29-1][1]."\">\n<title lang=\"zh\">".str_replace('<','',str_replace('>','',str_replace(':','',$name)))."</title>\n<desc lang=\"zh\"> </desc>\n</programme>\n";
...
))).' +0800'."\" channel=\"".$cid29[$idm29-1][1]."\">\n<title lang=\"zh\">".str_replace('<','',str_replace('>','',str_replace(':','',$name1)))."</title>\n<desc lang=\"zh\"> </desc>\n</programme>\n";
...
$chn.="<programme start=\"".$dt12.str_replace(':','',substr("".$unkk1011[$kkk1011][1]."",0,5)).'00 +0800'."\" stop=\"".$dt12.str_replace(':','',substr("".$unkk1011[$kkk1011][1]."",-5)).'00 +0800'."\" channel=\"香港電台33\">\n<title lang=\"zh\">".$ulkk1011[$kkk1011][1]."</title>\n<desc lang=\"zh\"> </desc>\n</programme>\n";
                  }
 $chn.="<programme start=\"".$dt12.str_replace(':','',str_replace('-','',substr("".$unkk1011[$trmkk1011-1][1]."",0,5))).'00 +0800'."\" stop=\"".$dt13.str_replace(':','',str_replace('-','',substr("".$unkk1011[$trmkk1011-1][1]."",-5))).'00 +0800'."\" channel=\"香港電台33\">\n<title lang=\"zh\">".$ulkk1011[$trmkk1011-1][1]."</title>\n<desc lang=\"zh\"> </desc>\n</programme>\n";
